...
set output "out/eps/RTree/TestCRTreeQuantization.eps"
...
plot "out/outfiles/RTree/TestCRTreeQuantizationAvg.txt" using 1:($3+$5+$7) with linespoints title "uint8_t" lw 3, \
