...
set output "out/eps/StaticJoin/StaticJoinScaleQueries.eps"
...
# plot "out/outfiles/StaticJoin/StaticJoinScaleQueriesAvg.txt" using 1:($3+$5+$7) with linespoints title "ListSweep" lw 7,\
...
# plot "out/outfiles/StaticJoin/StaticJoinScaleQueriesAvg.txt" using 1:(($3+$5+$7)/100.0) with linespoints title "List-Sweep" lw 7,\
...
plot "out/outfiles/StaticJoin/StaticJoinScaleQueriesAvg.txt" using 1:(($3+$5+$7)/100.0):(($9+$11+$13)/100.0):(($15+$17+$19)/100.0) with errorbars ls 1 lw 7 notitle,\
