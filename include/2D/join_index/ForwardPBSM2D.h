...
#ifndef _FORWARD_PBSM_2D_H_
#define _FORWARD_PBSM_2D_H_
...
namespace PSimIndex {
    ...
    class ForwardPBSM2D : public StaticSpatialJoin2D<U, K, A, RG> {
    private:
    ...
    public:
        ...
        static const char* getClassName() { return "ForwardPBSM2D"; }
         ...
         *
         * The query space is partitioned into a rectangular grid with tileDim^2
         * total tiles. There are tileDim columns and tileDim rows in the grid.
        ...
        void enumerationJoin(JoinCallBack<K,U,U>* cb,
            ...
            /*
             * Create a copy of query regions, and sort on lower x value. We
             * sort the regions once here, rather than individually in each
             * call of joinPartition, to avoid skew problems. If regions
             * appeared in multiple partitions, we would sort some regions
             * multiple times.
             */
...
//            this->numPartitions = 6;
        }
        ForwardPBSM2D(int tileDim, int numPartitions) {
            this->tileDim = tileDim;
            this->numPartitions = numPartitions;//tileDim * tileDim;
        }
