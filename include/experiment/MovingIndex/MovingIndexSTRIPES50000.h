...
#ifndef _MOVING_INDEX_STRIPES_50000_POINTS_H_
#define _MOVING_INDEX_STRIPES_50000_POINTS_H_
...
namespace PSimIndex {
    class MovingIndexSTRIPES50000 : public Experiment2D {
    public:
        void init() {
            ...
            workloadNum["scalepoints50000"] = 2;
        }


        MovingIndexSTRIPES50000() : Experiment2D() {}
    };
}

#endif /* _MOVING_INDEX_STRIPES_50000_POINTS_H_ */
