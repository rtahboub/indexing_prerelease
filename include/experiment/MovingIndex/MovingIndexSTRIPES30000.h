...
#ifndef _MOVING_INDEX_STRIPES_30000_POINTS_H_
#define _MOVING_INDEX_STRIPES_30000_POINTS_H_
...
namespace PSimIndex {
    class MovingIndexSTRIPES30000 : public Experiment2D {
    public:
        void init() {
        ...
        MovingIndexSTRIPES30000() : Experiment2D() {}
    };
}

#endif /* _MOVING_INDEX_STRIPES_30000_POINTS_H_ */
