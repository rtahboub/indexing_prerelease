...
#ifndef _PLANE_SWEEP_SCALE_QUERIES_H_
#define _PLANE_SWEEP_SCALE_QUERIES_H_
...
namespace PSimIndex {
    class PlaneSweepScaleQueries : public Experiment2D {
    public:
        void init() {


            folder = "out/traces/PlaneSweep/PlaneSweepScaleQueries";
            experimentName = "PlaneSweepScaleQueries";
        ...
        PlaneSweepScaleQueries() : Experiment2D() {}
    };
}



#endif /* _PLANE_SWEEP_SCALE_QUERIES_H_ */
