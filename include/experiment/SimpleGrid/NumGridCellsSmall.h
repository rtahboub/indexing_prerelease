...
#ifndef _NUM_GRID_CELLS_SMALL_H_
#define _NUM_GRID_CELLS_SMALL_H_
...
namespace PSimIndex {
    ...
    class NumGridCellsSmall : public Experiment2D {
    public:
        void init() {
            folder = "out/traces/SimpleGrid/NumGridCellsSmall";
            experimentName = "NumGridCellsSmall";
        ...
        NumGridCellsSmall() : Experiment2D() {}
    };
}

#endif /* _NUM_GRID_CELLS_SMALL_H_ */
