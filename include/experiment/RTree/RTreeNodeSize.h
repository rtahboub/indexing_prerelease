...
#ifndef _RTREE_NODE_SIZE_H_
#define _RTREE_NODE_SIZE_H_
...
namespace PSimIndex {
    class RTreeNodeSize : public Experiment2D {
    public:
        void init() {

            addIndexParam("EntrySize");
            folder = "out/traces/RTree/RTreeNodeSize/";
            experimentName = "RTreeNodeSize";
...
/*             } */
        ...
        RTreeNodeSize() : Experiment2D() {}
    };
}

#endif /* _RTREE_NODE_SIZE_H_ */
