...
#ifndef _RTREE_NODE_SIZE_GAUSS_H_
#define _RTREE_NODE_SIZE_GAUSS_H_
...
namespace PSimIndex {
    class RTreeNodeSizeGauss : public Experiment2D {
    public:
        void init() {

            addIndexParam("EntrySize");
            folder = "out/traces/RTree/RTreeNodeSizeGauss/";
            experimentName = "RTreeNodeSizeGauss";
        ...
        RTreeNodeSizeGauss() : Experiment2D() {}
    };
}

#endif /* _RTREE_NODE_SIZE_GAUSS_H_ */
