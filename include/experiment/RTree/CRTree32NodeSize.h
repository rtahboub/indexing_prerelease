...
#ifndef _CRTREE_32_NODE_SIZE_H_
#define _CRTREE_32_NODE_SIZE_H_
...
namespace PSimIndex {
    class CRTree32NodeSize : public Experiment2D {
    public:
        void init() {

            addIndexParam("EntrySize");
            folder = "out/traces/RTree/CRTree32NodeSize/";
            experimentName = "CRTree32NodeSize";
        ...
        CRTree32NodeSize() : Experiment2D() {}
    };
}

#endif /* _CRTREE_32_NODE_SIZE_H_ */
