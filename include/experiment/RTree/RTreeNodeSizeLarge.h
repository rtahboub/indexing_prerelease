...
#ifndef _RTREE_NODE_SIZE_LARGE_H_
#define _RTREE_NODE_SIZE_LARGE_H_
...
namespace PSimIndex {
    class RTreeNodeSizeLarge : public Experiment2D {
    public:
        void init() {

            addIndexParam("EntrySize");
            folder = "out/traces/RTree/RTreeNodeSizeLarge/";
            experimentName = "RTreeNodeSizeLarge";
        ...
        RTreeNodeSizeLarge() : Experiment2D() {}
    };
}

#endif /* _RTREE_NODE_SIZE_LARGE_H_ */
