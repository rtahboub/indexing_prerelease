...
#ifndef _CRTREE_8_NODE_SIZE_H_
#define _CRTREE_8_NODE_SIZE_H_
...
namespace PSimIndex {
    class CRTree8NodeSize : public Experiment2D {
    public:
        void init() {

            addIndexParam("EntrySize");
            folder = "out/traces/RTree/CRTree8NodeSize/";
            experimentName = "CRTree8NodeSize";
        ...
        CRTree8NodeSize() : Experiment2D() {}
    };
}

#endif /* _CRTREE_8_NODE_SIZE_H_ */
