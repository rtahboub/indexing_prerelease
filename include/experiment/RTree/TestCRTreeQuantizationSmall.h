...
#ifndef _TEST_CRTREE_QUANTIZATION_SMALL_H_
#define _TEST_CRTREE_QUANTIZATION_SMALL_H_
...
namespace PSimIndex {
    class TestCRTreeQuantizationSmall : public Experiment2D {
    public:
        void init() {

            addIndexParam("NumEntries");
            folder = "out/traces/RTree/TestCRTreeQuantizationSmall/";
            experimentName = "TestCRTreeQuantizationSmall";
            ...
            addWorkload(new TraceWorkload2D("traces/scalepoints1000.dat", true), 0);

        }

        TestCRTreeQuantizationSmall() : Experiment2D() {}
    };
}

#endif /* _TEST_CRTREE_QUANTIZATION_SMALL_H_ */
