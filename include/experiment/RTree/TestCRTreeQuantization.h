...
#ifndef _TEST_CRTREE_QUANTIZATION_H_
#define _TEST_CRTREE_QUANTIZATION_H_
...
namespace PSimIndex {
    class TestCRTreeQuantization : public Experiment2D {
    public:
        void init() {

            addIndexParam("NumEntries");
            folder = "out/traces/RTree/TestCRTreeQuantization/";
            experimentName = "TestCRTreeQuantization";
        ...
        TestCRTreeQuantization() : Experiment2D() {}
    };
}

#endif /* _TEST_CRTREE_QUANTIZATION__H_ */
