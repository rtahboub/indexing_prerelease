...
#ifndef _STATIC_JOIN_SCALE_UPDATES_H_
#define _STATIC_JOIN_SCALE_UPDATES_H_
...
namespace PSimIndex {
    class StaticJoinScaleUpdates : public Experiment2D {
    public:
        void init() {


            folder = "out/traces/StaticJoin/StaticJoinScaleUpdates";
            experimentName = "StaticJoinScaleUpdates";
            ...
            // addWorkload(new TraceWorkload2D("traces/query_update/query0.5.update0.1trial1.dat", true), 0, 0.1);
            // addWorkload(new TraceWorkload2D("traces/query_update/query0.5.update0.3trial1.dat", true), 0, 0.3);
            // addWorkload(new TraceWorkload2D("traces/query_update/query0.5.update0.5trial1.dat", true), 0, 0.5);
            // addWorkload(new TraceWorkload2D("traces/query_update/query0.5.update0.7trial1.dat", true), 0, 0.7);
            // addWorkload(new TraceWorkload2D("traces/query_update/query0.5.update0.9trial1.dat", true), 0, 0.9);
        ...
        StaticJoinScaleUpdates() : Experiment2D() {}
    };
}


#endif /* _STATIC_JOIN_SCALE_UPDATES_H_ */
